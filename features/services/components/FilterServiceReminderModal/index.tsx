...
interface FilterServiceReminderModalProps {
  isVisible: boolean;
...
const FilterServiceReminderModal: React.FC<FilterServiceReminderModalProps> = ({
  isVisible,
  setVisible,
  filters,
  onApplyFilters,
...
export default FilterServiceReminderModal;