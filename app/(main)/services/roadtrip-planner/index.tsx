  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor }]}>
      ...
      <View style={styles.content}>
        <Feather name="map" size={64} color="#96CEB4" />
        ...
        <Text size={14} color="grey70" style={styles.subtitle} autoTranslate={false}>
          Plan your perfect journey with route optimization. Coming soon!
        </Text>
      </View>
    </SafeAreaView>
  );
...
const styles = {
  ...
  header: { flexDirection: 'row' as const, alignItems: 'center' as const, justifyContent: 'space-between' as const, paddingVertical: 16, paddingBottom: 8 },
  backButton: { padding: 8, marginLeft: -8 },
  headerTitle: { flex: 1, textAlign: 'center' as const },
  headerSpacer: { width: 40 },
  content: { flex: 1, justifyContent: 'center' as const, alignItems: 'center' as const, paddingHorizontal: 20 },
