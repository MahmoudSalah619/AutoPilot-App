    ...
    <ModalWrapper isVisible={isVisible} setVisible={setVisible}>
      <View>
        <View style={[GLOBAL_STYLES.vhCentering, GLOBAL_STYLES.gap8]}>
          ...
          <Text>This is a random modal to show how to use the ModalWrapper component.</Text>
        </View>
        <View style={[GLOBAL_STYLES.rowJustifyBetween, GLOBAL_STYLES.gap8, { marginTop: 28 }]}>
          <Button title="Confirm" isFullWidth onPress={onSubmit} />
          <Button title="Not Now" isFullWidth variant="outlined" onPress={handleClose} />
        </View>
      </View>
    </ModalWrapper>
  );
